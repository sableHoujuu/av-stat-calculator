...
from src.common_prompts import range
...
def process_familiar(familiar_data: pd.Series) -> pd.Series:
    ...
    if familiar_data["familiar_dmg_modifier_min"] != familiar_data["familiar_dmg_modifier_max"]:
        ...
        processed_data["familiar_dmg_modifier"] = range(f"Enter the damage value on the familiar, between {min} and {max}", min, max)
    else:
    ...
    if familiar_data["familiar_spa_modifier_min"] != familiar_data["familiar_spa_modifier_max"]:
        min, max = familiar_data["familiar_spa_modifier_min"], familiar_data["familiar_spa_modifier_max"]
        processed_data["familiar_spa_modifier"] = range(f"Enter the SPA value on the familiar, between {min} and {max}", min, max)
    else:
    ...
    if familiar_data["familiar_rng_modifier_min"] != familiar_data["familiar_rng_modifier_max"]:
        ...
        processed_data["familiar_rng_modifier"] = range(f"Enter the range value on the familiar, between {min} and {max}", min, max)
    else:
    ...
    if familiar_data["familiar_crit_chance_modifier_min"] != familiar_data["familiar_crit_chance_modifier_max"]:
        ...
        processed_data["familiar_crit_chance_modifier"] = range(f"Enter the crit chance value on the familiar, between {min} and {max}", min, max)
    else:
    ...
    if familiar_data["familiar_crit_dmg_modifier_min"] != familiar_data["familiar_crit_dmg_modifier_max"]:
        ...
        processed_data["familiar_crit_dmg_modifier"] = range(f"Enter the crit damage value on the familiar, between {min} and {max}", min, max)
    else:
